...
const tripDaysTemplate = `<ul class="trip-days"></ul>`

const dayTemplate = `<li class="trip-days__item  day"></li>`
...
render(infoAndCostTemplate, tripMain, 'afterbegin')
render(tabsTemplate, tripControls, 'beforeend')
render(filtersTemplate, tripControls, 'beforeend')
render(sortTemplate, tripEvents, 'beforeend')
render(tripDaysTemplate, tripEvents, 'beforeend')

const tripDays = tripEvents.querySelector('.trip-days')

render(dayTemplate, tripDays, 'beforeend')

const day = tripDays.querySelector('.day')

render(dayInfoTemplate, day, 'beforeend')
render(eventsListTemplate, day, 'beforeend')

const eventsList = day.querySelector('.trip-events__list')

render(formTemplate, eventsList, 'beforeend')

for (let i = 0; i < PLACE_POINT_AMOUNT; i++) {
  render(eventTemplate, eventsList, 'beforeend')
}
